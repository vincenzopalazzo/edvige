...
export type GatewayStatusRequest_unstable = {
    [key: string]: unknown;
};

export type GatewayStatusResponse_unstable = {
    gateways: Array<GatewayStatusDto>;
};
...
export type GatewayStatusDto = {
    ...
    running: boolean;
    configured: boolean;
    pairedUsers: Array<GatewayPairedUserDto>;
    info?: {
        [key: string]: string;
    };
};

export type GatewayPairedUserDto = {
    platform: string;
    userId: string;
...
export type StartSonarGatewayRequest_unstable = {
    controllers: Array<string>;
    relays?: Array<string>;
};

export type StartSonarGatewayResponse_unstable = {
    gateway: GatewayStatusDto;
};

export type PairSonarGatewayRequest_unstable = {
    sessionId?: string | null;
};

export type PairSonarGatewayResponse_unstable = {
    code: string;
    expiresAt: number;
};

export type StopSonarGatewayRequest_unstable = {
    forget?: boolean;
};

export type UnpairSonarGatewayRequest_unstable = {
    groupId: string;
};

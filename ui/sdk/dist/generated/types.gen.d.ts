...
export type SessionActivityResponse_unstable = {
    ...
    days?: Array<SessionActivityDay>;
    models?: Array<SessionActivityModel>;
};
export type SessionActivityDay = {
    date: string;
    sessionCount: number;
    totalTokens: number;
 ...
 */
export type SetSessionStatusRequest_unstable = {
    sessionId: string;
    status: string;
};
/**

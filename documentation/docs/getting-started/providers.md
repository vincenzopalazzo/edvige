...
| [xAI](https://x.ai/)                                                        | Access to xAI's Grok models, including grok-4.7, grok-4.6, and grok-4.5, with up to a 500,000 token context window.                                                                                                            | `XAI_API_KEY`, `XAI_HOST` (optional)                                                                                                                                                |
